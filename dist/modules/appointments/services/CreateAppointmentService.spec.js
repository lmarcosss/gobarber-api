...
describe('CreateAppointment', function () {
    it('should be able to create a new appointment', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentRepository, createAppointmentService, appointment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentRepository = new FakeAppointmentsRepository_1.default();
                    createAppointmentService = new CreateAppointmentService_1.default(fakeAppointmentRepository);
    ...
    it('should not be able to create two appointments on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentRepository, createAppointmentService, appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentRepository = new FakeAppointmentsRepository_1.default();
                    createAppointmentService = new CreateAppointmentService_1.default(fakeAppointmentRepository);
                    appointmentDate = new Date(2020, 4, 10, 11);
                    return [4 /*yield*/, createAppointmentService.execute({
