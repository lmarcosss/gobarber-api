...
var FakeUserTokenRepository = /** @class */ (function () {
    function FakeUserTokenRepository() {
        this.userTokens = [];
    }
    FakeUserTokenRepository.prototype.generate = function (userId) {
    ...
    FakeUserTokenRepository.prototype.findByToken = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var userToken;
            return __generator(this, function (_a) {
    ...
    return FakeUserTokenRepository;
}());
