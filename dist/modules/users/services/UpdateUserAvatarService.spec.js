...
describe('UpdateUserAvatar', function () {
    it('should be able to update user avatar', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeStorageProvider, updateUserAvatar, user;
    ...
    it('should not be able to update avatar from no existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeStorageProvider, updateUserAvatar;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRepository = new FakeUsersRepository_1.default();
    ...
    it('should delete old avatar when updating new one', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeStorageProvider, deleteFile, updateUserAvatar, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRepository = new FakeUsersRepository_1.default();
