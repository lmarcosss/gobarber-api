...
describe('ResetPassword', function () {
    ...
    it('should not be able to reset password because token doesn`t exists', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should not be able to reset password because user doesn`t exists', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserTokensRepository.generate('131242534')];
                case 1:
                    token = (_a.sent()).token;
    ...
    it('should not be able to reset password if passed more than two hours', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserRepository.create({
