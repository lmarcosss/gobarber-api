...
var ResetPasswordService = /** @class */ (function () {
    ...
    ResetPasswordService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userToken, tokenCreatedAt, compareDate, user, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        userToken = _c.sent();
                        if (!userToken) {
                            throw new AppError_1.default('User token doesn`t exists');
                        }
                        ...
                        return [4 /*yield*/, this.usersRepository.findById(userToken.userId)];
                    case 2:
                        user = _c.sent();
                        if (!user) {
