...
describe('SendForgotPasswordEmail', function () {
    beforeEach(function () {
        ...
        sendForgotPasswordEmailService = new SendForgotPasswordEmailService_1.default(fakeUserRepository, fakeMailProvider, fakeUserTokensRepository);
    });
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sendMail = spyOn(fakeMailProvider, 'sendMail');
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordEmailService.execute({ email: 'leonardo@gmail.com' })];
                case 2:
                    _a.sent();
    ...
    it('should not be able recover a non-existing user mail', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generateToken = spyOn(fakeUserTokensRepository, 'generate');
                    return [4 /*yield*/, fakeUserRepository.create({
                            name: 'Leonardo Marcos',
                            email: 'leonardo@gmail.com',
                            password: '123456789',
